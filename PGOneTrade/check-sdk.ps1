# Check .NET SDK setup for PG One Trade (requires .NET 10 SDK for MAUI 10)
Write-Host "PG One Trade - .NET SDK Check" -ForegroundColor Cyan
...
if ($hasNet10) {
    ...
    Write-Host ""
    Write-Host "PG One Trade targets net10.0-windows (MAUI 10). Install:" -ForegroundColor Yellow
