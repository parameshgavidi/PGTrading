...
{
    private const string NavKey = "pgonetrade.layout.navCollapsed";
    private const string WatchKey = "pgonetrade.layout.watchlistCollapsed";
    private const string NiftyAccKey = "pgonetrade.layout.niftyAccordionOpen";
    private const string FocusKey = "pgonetrade.layout.focusChart";
