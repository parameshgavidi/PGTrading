...
public static class AiInsightHelper
{
    public static IReadOnlyList<AiCheck> BuildChecks(MultiTimeframeAnalysis analysis)
    {
        ...
        [
            ...
            new(footprintPass
                ? $"Footprint OK · {FootprintDisplayHelper.GetFlowBiasLabel(analysis.Footprint)} · {FootprintDisplayHelper.GetShortDeltaLabel(analysis.Footprint)}"
                : FootprintDisplayHelper.GetInsightLabel(analysis.Footprint),
