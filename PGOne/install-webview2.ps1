# Install Microsoft Edge WebView2 Runtime (required for PG One UI on Windows)
Write-Host "PG One requires WebView2 to display the trading UI." -ForegroundColor Cyan
Write-Host ""
