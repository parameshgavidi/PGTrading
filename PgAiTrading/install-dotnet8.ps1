# PG AI Trading - Install .NET 8 SDK (run as normal user, not admin required for winget in some cases)
Write-Host "PG AI Trading - .NET 8 SDK Installer" -ForegroundColor Cyan
