# Install Microsoft Edge WebView2 Runtime (required for PG AI Trading UI on Windows)
Write-Host "PG AI Trading requires WebView2 to display the trading UI." -ForegroundColor Cyan
Write-Host ""
