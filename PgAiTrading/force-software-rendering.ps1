...
Write-Host ""
Write-Host "Now launch PgAiTrading.exe from THIS PowerShell window (not double-click), e.g.:" -ForegroundColor Yellow
Write-Host "  .\bin\x64\Debug\net10.0-windows10.0.19041.0\win-x64\PgAiTrading.exe"
Write-Host ""
